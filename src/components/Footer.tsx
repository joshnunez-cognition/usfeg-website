...
import { aboutBlurb, contact, externalLinks, navItems } from '../data/site'
    ...
    <footer id="contact" className="bg-brand-navy-dark text-white">
      <div className="container-x grid gap-10 py-14 md:grid-cols-2 lg:grid-cols-12 lg:py-20">
        <div className="lg:col-span-4">
          <img src={asset('/logo.svg')} alt="" className="h-12 w-auto rounded-lg bg-white px-3 py-2" />
        ...
        <div className="md:col-span-2 lg:col-span-5">
          ...
          <p className="mt-4 text-sm text-white/75">
            Interested in joining a chapter or starting one in your area? Send us a note and Rod will get back to you.
          </p>
          <div className="mt-5">
            <ContactForm />
          </div>
